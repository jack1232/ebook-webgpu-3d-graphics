...
const run = async () => {
    ...
    gui.add(params, 'surfaceType', [
        'astroid', 'astroid2', 'astroidalTorus', 'bohemianDome', 'boyShape', 'breather', 'enneper', 
        'figure8', 'henneberg', 'kiss', 'kleinBottle', 'kleinBottle2', 'kleinBottle3', 'kuen', 
        'minimal', 'parabolicCyclide', 'pear', 'pluckerConoid', 'seashell', 'sievertEnneper',
        'steiner', 'torus', 'wellenkugel'
